  ...
  return (
    <div className="bg-background flex overflow-hidden rounded p-2 shadow-lg">
      <div className="inline-flex items-center gap-1">
        ...
        <Separator orientation="vertical" />
        {/* This registry component's tooltipOptions originally passed Radix's
            onPointerDownOutside here - our shadcn init uses Base UI (see TECH_STACK.md),
            whose TooltipContent doesn't expose that prop name, and its own default
            outside-dismiss behavior is sufficient without it. */}
