...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // A plain 1px border, no ring/shadow - a real panel earns a boundary, not a
        // floating-card look (see TECH_STACK.md's "dividers, not cards" note; list rows
        // moved off Card entirely rather than getting a flatter Card).
